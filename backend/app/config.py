...
class Settings(BaseSettings):
    ...
    # channel key the registry does not know about is logged and
    # treated as "no failover" so a typo does not block message
    # delivery at runtime. The contract is documented in
